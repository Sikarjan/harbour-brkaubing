    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Text {
                ...
                text: "<html><style>a {color:"+ Theme.primaryColor +";}</style>Version 1.5.1<br>"+qsTr("Contact")+": <a href=\"mailto:Admin@brk-aubing.de\">Admin@brk-aubing.de</a><br>Homepage: <a href=\"https://brk-aubing.de\">brk-aubing.de</a></html>"
